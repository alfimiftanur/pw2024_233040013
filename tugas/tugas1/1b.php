<?php
    ...
    echo "Jika aku ditambah 75, maka aku sekarang menjadi <strong>". ($npm += 75) ."</strong> <br>";
    echo "Jika aku dikurang 20, maka aku sekarang menjadi <strong>". ($npm -= 20) ."</strong> <br>";
